...
2. We need to be able to understand what certain variables predict and what there impact is and it's impractical to do that if we have hundreds of variables.
